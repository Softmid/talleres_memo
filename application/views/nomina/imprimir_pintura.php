...
<div class="panel panel-default visable-print">
    <div class="panel-heading">Impresion Pintura</div>
    <div class="panel-body">
            ...
            <div class="col-xs-11 col-xs-offset-1">
               ...
               <p class="col-xs-3">
                   <table class="table table-striped">
                       ...
                       <tbody>
                    <? foreach($pintura->result() as $pint) {
                            echo "<tr>";
                            echo "<td>".$pint->clave."</td>";
                            echo "<td>$".$pint->preparacion."</td>";
                            echo "<td>$".$pint->pintura."</td>";
                            echo "<td>$".$pint->total_pintura."</td>";
                            echo "</tr>";
                            $suma_pintura += $pint->total_pintura;
                     } ?>
                       </tbody>
                   </table>
               </p>
        ...
        <div class="percepciones row">
            ...
            <h2>Percepciones</h2>
            <p>Produccion: <? echo $suma_pintura; ?></p>
            </div>
            <div class="col-xs-5 col-xs-offset-1">
                <h2>A Recibir</h2>
