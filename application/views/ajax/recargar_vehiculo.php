			...
			?>
                    ...
                    <tr class="hijo" data-id="<? echo $vehiculo->clave; ?>" style="display:none">
                       <td align="center"><a href="index.php/vehiculo/modificarVehiculo/<?php echo $vehiculo->idVehiculo?>/<?php echo $vehiculo->idOrdenes?>" class="link-boton-modificar link-boton-menu" data-open="vista-modificar-carro" ><i class="icon-cogs"></i>Modificar</a></td>
                        ...
                        <td align="center"><a class=" link-boton-menu" href="index.php/vehiculo/impresionOrden_Inventario/<?php echo $vehiculo->idVehiculo?>/<?php echo $vehiculo->idOrdenes?>"><i class="icon-print"></i>Imprimir Inventario</a></td> 
                        ...
                        <td align="center"><a href="index.php/vehiculo/cierre/<?php echo $vehiculo->idVehiculo?>/<?php echo $vehiculo->idOrdenes?>" class="link-boton-modificar link-boton-menu" data-open="vista-modificar-carro" ><i class="icon-cogs"></i>Cierre</a></td>
