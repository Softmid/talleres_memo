	...
	$(function (){
		$('.subcategoria').click(function(){
			...
			if(marcado == true)
			{
				...
				$.post("index.php/servicios/C_eliminarSubCategoria",{tipo:1, id:id});
				$(this).parent().addClass('active');
			}
			else
			{
				var id = $(this).attr('data-id');
				$.post("index.php/servicios/C_eliminarSubCategoria",{tipo:0, id:id});
		...
		{
			var id = $(this).attr('data-id');
			$.post("index.php/servicios/C_eliminarSubCategoria",{id:id},
			function(data)
			{
