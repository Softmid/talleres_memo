<?php
	...
	foreach($categorias->result() as $categoria)
	{
		...
		{
			echo '<li><aside class="izquierda"><input type="checkbox" name="categoria" id="input2-'.$count2.'" class="categoria" data-id="'.$categoria->idCategorias.'" value="'.$categoria->idCategorias.'"/><label for="input2-'.$count2.'">'.$categoria->nombre.'</label><li></aside><aside class="derecha"><a class="eliminar" data-id="'.$categoria->idCategorias.'">X</a></aside>';
		}
		$count2++;
	}
?>
