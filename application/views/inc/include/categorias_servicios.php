<section id="form_agregarCategorias" title="Formulario Agregar Categoria" style="display:none;">
    ...
    <aside class="contenedor-categoria">
    	<form method="post" accept-charset="utf-8" id="form_categorias">
            <ul id="datos">
                <li><h2>Datos de la Categoria Servicios<span>>></span></h2></li>
    ...
    <script type="text/javascript">
			function enviarRegistroCategoria()
			{
				if($("#form_categorias").valid())
				{
					...
					$.post("index.php/servicios/C_agregar_categoria",$("#form_categorias").serialize(),
					function()
					{
    ...
    <aside class="contenedor-categoria">
    	...
    	<ul id="datos">
                ...
                <li id="update_categoria_servicios">
                ...
                <li><input type="text" name="subCategoria_servicios" value="" id="subCategoria_servicios" placeholder="Sub-Categoria" /></li>
    ...
    <script type="text/javascript">
		function enviarSubcategoria()
		{
			if($("#form_subCategorias").valid())
			{
				...
				$.post("index.php/servicios/C_agregarSubcategoria",$("#form_subCategorias").serialize(),
				function(data)
				{
    ...
    <aside class="contenedor-categoria clear">
        <form method="post" accept-charset="utf-8" id="form_eliminarCategorias">
            <ul id="datos">
                ...
                <li>
                	<ul class="lista-categoria refrescar-categoria_servicios">
                        <?php
							$count2=1;
							foreach($categorias->result() as $categoria)
							{
								...
								{
									echo '<li data-id="'.$categoria->idCategorias.'" ><aside class="izquierda"><input type="checkbox" name="categoria" id="input2-'.$count2.'" class="categoria" data-id="'.$categoria->idCategorias.'" value="'.$categoria->idCategorias.'"/><label for="input2-'.$count2.'">'.$categoria->nombre.'</label><li></aside><aside class="derecha"><a class="eliminar_servicios" data-id="'.$categoria->idCategorias.'">X</a></aside>';
								}
								$count2++;
							}
                        ?>
        ...
        <form method="post" accept-charset="utf-8" id="form_eliminarSubCategorias">
            <ul id="datos">
            	<li><h2>Eliminar Sub-Categoria<span>>></span></h2></li>
                 <li id="update_categoria_servicios2">
...
<script type="text/javascript">
	$(function (){
		$('.categoria-val').change(function(){
			...
			var id = $(this).val();
			$.post('index.php/servicios/verSubcategoria', {id : id},  function(data){
