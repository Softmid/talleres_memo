...
<form class="form-horizontal" method="post" role="form">
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control no-margin" id="observaciones" required autofocus name="observaciones" value="<? echo $datos_cierre->observaciones; ?>" placeholder="Observaciones">
    </div>
